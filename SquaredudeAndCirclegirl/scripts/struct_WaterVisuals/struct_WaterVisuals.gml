...
function WaterVisuals(_xx, _yy, _zz) constructor {
  ...
  step = function() {
    ...
    if (timer > 15) {
      ...
      part_emitter_burst(ctrl_Particles.player_spawn_system, ctrl_Particles.player_spawn_emitter, ctrl_Particles.attack_water, 80);
    }
